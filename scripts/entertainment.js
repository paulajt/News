/*File with the code to manage the entertainment page*/ 

//Function to manage what is shown in the entertainment page
function entertainment() {
  console.log('This is the entertainment page!');

   /*Ajax call to NewsApi to receive News information in json format. 
  I make the request of all the news which contains the word entertainment,
  sorting the results by popularity to show the most important ones*/
  $.ajax({
    url: 'https://newsapi.org/v2/everything?q=entertainment&apiKey=6a3c3f9a3a1848d2b14bf153f7adfa8b',
    dataType: "json",
    type:'GET',
    crossDomain:true,
    success: function(response) {
      ...
      $(".entertainment-page").html(value);                  
    }
  });
}

//Call to the "registerPage" method in index.js to send the name and fuction of the entertainment page.
registerPage('entertainment', entertainment);