/*File with the code to manage the science page*/ 

//Function to manage what is shown in the science page
function science() {
  console.log('This is the science page!');

  /*Ajax call to NewsApi to receive News information in json format. 
  I make the request of all the news which contains the word science,
  sorting the results by popularity to show the most important ones*/
  $.ajax({
    url: 'https://newsapi.org/v2/everything?q=science&sortBy=popularity&apiKey=6a3c3f9a3a1848d2b14bf153f7adfa8b',
    dataType: "json",
    type:'GET',
    crossDomain:true,
    success: function(response) {
      ...
      $(".science-page").html(value);            
    }
  });
}


//Call to the "registerPage" method in index.js to send the name and fuction of the science page.
registerPage('science', science);