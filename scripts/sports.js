/*File with the code to manage the sports page*/ 

//Function to manage what is shown in the sports page
function sports() {
    console.log('This is the sports page!');

    /*Ajax call to NewsApi to receive News information in json format. 
  I make the request of all the news which contains the word sport,
  sorting the results by popularity to show the most important ones*/
  $.ajax({
    url: 'https://newsapi.org/v2/everything?q=sport&apiKey=6a3c3f9a3a1848d2b14bf153f7adfa8b',
    dataType: "json",
    type:'GET',
    crossDomain:true,
    success: function(response) {
      ...
      $(".sports-page").html(value);             
    }
  });
}
  
  //Call to the "registerPage" method in index.js to send the name and fuction of the sports page.
  registerPage('sports', sports);