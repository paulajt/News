/*File with the code to manage the world page*/ 

//Function to manage what is shown in the world page
function world() {
  //Message in the console to verify the page in which we are
  console.log('This is the world page!');
     
  /*Ajax call to NewsApi to receive News information in json format. 
  I make the request of all the news which contains the word nationality,
  sorting the results by popularity to show the most important ones*/
  $.ajax({
    url: 'https://newsapi.org/v2/everything?q=nationality&sortBy=popularity&apiKey=6a3c3f9a3a1848d2b14bf153f7adfa8b',
    dataType: "json",
    type:'GET',
    crossDomain:true,
    success: function(response) {
      ...
      $(".world-page").html(value);              
    }
  });
}

//Call to the "registerPage" method in index.js to send the name and fuction of the world page.  
registerPage('world', world);